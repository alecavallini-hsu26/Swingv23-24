...
public class SwingControlDemo implements ActionListener {
    ...
    private void prepareGUI() {
        mainFrame = new JFrame("Ale Learning Swing");
        mainFrame.setSize(WIDTH, HEIGHT);
        mainFrame.setLayout(new GridLayout(3, 1));

        /**
         * WIll be using three types of layouts
         * - Grid Layout
         * - Flow Layout
         *   - Everything goes top center - Like middle text on google docs
         * Three grids in this example
         */
